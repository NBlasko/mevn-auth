    ...
    <form v-if="!signingUp" @submit.prevent="signup">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input v-model="user.confirmPassword" type="password" class="form-control" id="confirmPassword" aria-describedby="confirmPasswordHelp" required>

        </div>
      </div>
      <button type="submit" class="btn btn-primary">Signup</button>
    </form>
    <div><router-link to="/signin"> I am already a member </router-link> </div>
    </div>
  </section>
</template>
